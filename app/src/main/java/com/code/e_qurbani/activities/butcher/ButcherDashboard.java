...
public class ButcherDashboard extends AppCompatActivity {
    private ActivityButcherDashboardBinding binding;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityButcherDashboardBinding.inflate(getLayoutInflater());
        ...
        binding.crdOrderRecordAvaliable.setOnClickListener(view -> {
            startActivity(new Intent(this, ProposalRecordTracker.class).putExtra(Constant.GET_ROLE,Constant.BUTCHER));
        });
