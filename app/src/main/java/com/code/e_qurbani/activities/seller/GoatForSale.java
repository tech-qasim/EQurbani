...
import com.code.e_qurbani.databinding.ActivityGoatForSaleBinding;
...
public class GoatForSale extends AppCompatActivity {

    ActivityGoatForSaleBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityGoatForSaleBinding.inflate(getLayoutInflater());
