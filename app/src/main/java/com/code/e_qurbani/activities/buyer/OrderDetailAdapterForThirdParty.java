...
public class OrderDetailAdapterForThirdParty extends RecyclerView.Adapter<OrderDetailAdapterForThirdParty.ButcherViewHolder> {
    Context context;
    ArrayList<ThirdPartyProposal> butcherList;
    Dialog dialog;
    ...
    public OrderDetailAdapterForThirdParty(Context context, ArrayList<ThirdPartyProposal> butcherList, Dialog dialog, String screen) {
    ...
    public void onBindViewHolder(@NonNull ButcherViewHolder holder, int position) {
        ThirdPartyProposal butcherProposal = this.butcherList.get(position);
            ...
            docRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful())
                    {
                        ...
                        {
                            ThirdParty butcher = documentSnapshot.toObject(ThirdParty.class);

//                            context.startActivity(new Intent(context, ChatScreen.class).putExtra(Constant.BUTCHER, butcher));

                            context.startActivity(new Intent(context, ThirdPartyChat.class).putExtra(Constant.THIRD_PARTY, butcher));
...
//
//
////                                Toast.makeText(context, butcher.getContactNumber(), Toast.LENGTH_SHORT).show();
//
//                                Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + butcherProposal.getPhoneNumber()));
//                                context.startActivity(intent);
//
...
//                context.startActivity(intent);
    ...
    private void showRatingDialog(ButcherViewHolder holder, ThirdPartyProposal butcherProposal) {
        ...
        buttonSubmit.setOnClickListener(v -> {
            ...
            updateStarRatingOnFirestoreForThirdParty(butcherProposal, String.valueOf(rating), editText.getText().toString());
...
//            }
    ...
    private void updateStarRatingOnFirestoreForThirdParty(ThirdPartyProposal butcherProposal, String rating, String review)
    {
        ...
        if (userId != null) {
            firebaseFirestore.collection(Constant.BUYER)
                    .document(userId)
                    .collection(Constant.PROPOSALTHIRDPARTY)
