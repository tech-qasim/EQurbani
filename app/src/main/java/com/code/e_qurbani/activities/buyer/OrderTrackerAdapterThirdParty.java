...
public class OrderTrackerAdapterThirdParty extends RecyclerView.Adapter<OrderTrackerAdapterThirdParty.ButcherViewHolder> {
    Context context;
    ArrayList<ThirdPartyProposal> butcherList;
    Dialog dialog;

    public OrderTrackerAdapterThirdParty(Context context, ArrayList<ThirdPartyProposal> butcherList, Dialog dialog) {
...
// Fetch the document
//            Toast.makeText(context, getSubstringUntilSecondSlash(butcherProposal.getBuyerDocRef()), Toast.LENGTH_SHORT).show();
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            ...
                            ThirdParty butcher = document.toObject(ThirdParty.class);
...
//                            context.startActivity(new Intent(context, ThirdPartyChat.class).putExtra(Constant.BUTCHER, butcher));
...
//        Toast.makeText(context, String.valueOf(butcherList.size()), Toast.LENGTH_SHORT).show();
