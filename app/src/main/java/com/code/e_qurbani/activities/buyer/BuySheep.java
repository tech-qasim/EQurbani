...
import com.code.e_qurbani.databinding.ActivityBuySheepBinding;
...
public class BuySheep extends AppCompatActivity {

    ActivityBuySheepBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBuySheepBinding.inflate(getLayoutInflater());
