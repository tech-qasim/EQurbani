...
public class CowBullOnSale extends AppCompatActivity {

    ActivityCowBullOnSaleBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCowBullOnSaleBinding.inflate(getLayoutInflater());
