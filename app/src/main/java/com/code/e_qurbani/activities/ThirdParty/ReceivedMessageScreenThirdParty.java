...
public class ReceivedMessageScreenThirdParty extends AppCompatActivity {
    ...
    ReceivedMessageAdapterThirdParty adapter;
...
//    private RecyclerView recyclerView;
    ...
    private ArrayList<ThirdParty> butcherArrayList = new ArrayList<>();
...
//        Log.i("current user",current);
    ...
    private void getUserData(String uid) {
        ...
        db.collection(Constant.THIRD_PARTY).document(uid).get()
...
//                        String name = documentSnapshot.getString("name");
    ...
    private void buildRecyclerView ()
    {
        ...
        adapter = new ReceivedMessageAdapterThirdParty(this, usernames);
