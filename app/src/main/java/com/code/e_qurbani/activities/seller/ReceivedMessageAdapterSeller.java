...
public class ReceivedMessageAdapterSeller extends RecyclerView.Adapter<ReceivedMessageAdapterSeller.ButcherViewHolder> {
    Context context;
    ...
    public ReceivedMessageAdapterSeller(Context context, ArrayList<String> usernames) {
...
//        Butcher butcher = this.butcherList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, SellerChat.class);
