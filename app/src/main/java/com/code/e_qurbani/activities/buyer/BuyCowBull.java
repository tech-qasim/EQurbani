...
import com.code.e_qurbani.databinding.ActivityBuyCowBullBinding;
...
public class BuyCowBull extends AppCompatActivity {
    ActivityBuyCowBullBinding binding;
    ...
    String collectionName = Constant.COW;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityBuyCowBullBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        Log.d("onBindViewHolder", "BowCowBull: ");
