...
public class ThirdPartyProposal implements Parcelable {
    ...
    public ThirdPartyProposal(Parcel in) {
    ...
    public static final Creator<ThirdPartyProposal> CREATOR = new Creator<ThirdPartyProposal>() {
        @Override
        public ThirdPartyProposal createFromParcel(Parcel in) {
            return new ThirdPartyProposal(in);
        }

        @Override
        public ThirdPartyProposal[] newArray(int size) {
            return new ThirdPartyProposal[size];
        }
    };
