...
import com.code.e_qurbani.databinding.ActivitySheepOnSaleBinding;
...
public class SheepOnSale extends AppCompatActivity {

    ActivitySheepOnSaleBinding binding;
    ...
    String collectionName = Constant.SHEEP;
    FirebaseSellerAnimalSource firebaseSellerAnimalSource;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySheepOnSaleBinding.inflate(getLayoutInflater());
